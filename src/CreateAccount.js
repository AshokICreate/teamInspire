      ...
      <TouchableWithoutFeedback onPress={() => DismissKeyBoard()}>
        <View style={containerStyle.container}>
            ...
            <View style={topContainerStyle.topContainer}>
              <Text style={topContainerStyle.textStyle}>Create Account</Text>
            </View>
                      ...
                      <TextInput ref="usr"
                       ...
                       <TextInput ref="psw"
                        ...
                        <TextInput ref="psw"
                         ...
                         />
                        <TouchableHighlight underlayColor="#FFFFFF" style={middleContainerStyle.loginButtonContainerStyle} onPress={this.onSubmit}>
                            <Text style={middleContainerStyle.loginButtonStyle}>Submit</Text>
                        </TouchableHighlight>
                        <TouchableHighlight underlayColor="#FFFFFF" style={middleContainerStyle.forgotPasswordButtonContainerStyle} onPress={this.onAlreadyHaveAnAcc}>
