      ...
      <TouchableWithoutFeedback onPress={() => DismissKeyBoard()}>
        <View style={containerStyle.container}>
            ...
            <View style={topContainerStyle.topContainer}>
              <Text style={topContainerStyle.textStyle}>Forgot Password</Text>
            </View>
              ...
              <View style={middleContainerStyle.row_2_Style}>
                      <TextInput ref="usr"
                       ...
                       />
                        ...
                        <TouchableHighlight underlayColor="#FFFFFF" style={middleContainerStyle.forgotPasswordButtonContainerStyle} onPress={this.onCancel}>
                            <Text style={middleContainerStyle.forgotButtonStyle}>Cancel</Text>
                        </TouchableHighlight>
                  </View>
